  ...
  return (
    <div className="mx-[5.5rem] ">
      <div className="  mt-[5.5rem] relative">
        <p className=" min-w-[40.2rem] w-[50%] m-auto text-[3.5rem] text-center font-bold   ">
          Discover Furniture With High Quality Wood
        </p>
        <img src="/bg1.svg" alt="" className="absolute bottom-0 left-0" />
      </div>
      <p className="min-w-[44.2rem] w-[50%] m-auto text-center text-[#AFADB5] mt-[1.7rem] mb-[5.1rem] ">
